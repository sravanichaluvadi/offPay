...
export const BackspaceIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const ReceiptIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-1.5h5.25m-5.25 0h3m-3 0h-1.5m3 0h.75M9 12l3 3m0 0l3-3m-3 3v-6m-1.5-1.5h5.25m-5.25 0h3m-3 0h-1.5m3 0h.75M9 6v.75m0 3v.75m0 3V15m3-3h3" />
  </svg>
);

export const CogIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-.962a8.958 8.958 0 017.313 7.314c.045.55-.422 1.02-.962 1.11l-1.524.282c-.298.055-.504.332-.446.634l.26.868c.096.323.394.541.723.501L19.5 14.25c.498-.09.995.166 1.173.648l.255 1.02a1.125 1.125 0 01-.46 1.45l-1.586.97c-.43.266-.633.752-.46 1.205l.422 1.138a1.125 1.125 0 01-1.342 1.342l-1.138.422c-.453.172-.94.032-1.205-.46l-.97-1.586a1.125 1.125 0 00-1.45-.46l-1.02.255c-.482.178-.958-.175-1.173-.648l-.282-1.524c-.06-.302-.348-.508-.634-.446l-.868.26c-.329.04-.627-.178-.723-.501L5.75 14.25c-.09-.498.166-.995.648-1.173l1.02-.255a1.125 1.125 0 001.45-.46l1.586-.97c.266-.43.032-.94-.46-1.205l-1.138-.422a1.125 1.125 0 01-1.342-1.342l-.422-1.138c-.172-.453.032-.94.46-1.205l.97-1.586a1.125 1.125 0 00.46-1.45l-.255-1.02a1.125 1.125 0 01.648-1.173L9.594 3.94zM11.25 12a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />
    </svg>
);
...
export const UssdIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const InformationCircleIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 11.25l.25.25m0 0l-2.5 2.5M11.25 11.25l2.5-2.5M11.25 11.25L9 13.5m2.25-2.25l2.5 2.5m-3.5 6.5a9 9 0 11-18 0 9 9 0 0118 0zM12 8.25h.01v.01H12V8.25z" />
  </svg>
);
